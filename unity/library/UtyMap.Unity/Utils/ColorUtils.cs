...
namespace UtyMap.Unity.Utils
{
    ...
    public static class ColorUtils
    {
        ...
        public static Color FromName(string name)
        {
            ...
            var color32 = KnownColors.ContainsKey(lowerCaseName)
        ...
        /// <returns>Color.</returns>
        public static Color FromUnknown(string colorString)
        {
        ...
        /// <summary> Returns ARGB-color from its integer representation. </summary>
