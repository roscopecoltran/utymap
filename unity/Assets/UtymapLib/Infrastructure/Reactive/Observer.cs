...
namespace Assets.UtymapLib.Infrastructure.Reactive
{
    ...
    public static partial class ObservableExtensions
    {
        ...
        public static IDisposable Subscribe<T>(this IObservable<T> source, Action onCompleted)
        {
            return source.Subscribe(Observer.Create<T>(Stubs.Ignore<T>, Stubs.Throw, onCompleted));
        }
