...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        [SerializeField] public float m_RollSpeed = 0.2f;// How fast the rig will roll (around Z axis) to match target's roll.
        ...
        [SerializeField] public float m_SpinTurnLimit = 90;// The threshold beyond which the camera stops following the target's rotation. (used in situations where a car spins out, for example)
