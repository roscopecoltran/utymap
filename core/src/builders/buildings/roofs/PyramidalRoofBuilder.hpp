#ifndef SCENE_BUILDINGS_FACADES_PYRAMIDALROOFBUILDER_HPP_DEFINED
#define SCENE_BUILDINGS_FACADES_PYRAMIDALROOFBUILDER_HPP_DEFINED
...
#endif // SCENE_BUILDINGS_FACADES_PYRAMIDALROOFBUILDER_HPP_DEFINED
