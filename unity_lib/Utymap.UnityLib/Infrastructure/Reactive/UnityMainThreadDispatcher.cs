...
using Utymap.UnityLib.Infrastructure.Reactive.InternalUtil;
using UnityEngine;
        ...
        public static void Initialize()
        {
            if (!initialized)
            {
                ...
                catch
                {
                    ...
                    var ex = new Exception("Utymap.UnityLib.Infrastructure.Reactive requires a UnityMainThreadDispatcher component created on the main thread. Make sure it is added to the scene before calling Utymap.UnityLib.Infrastructure.Reactive from a worker thread.");
